  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        const generateUniqueCode = Math.floor(10 + Math.random() * 90);
      ...
      .catch((error: unknown) => {
        if (axios.isAxiosError(error)) {
          ...
          setError("An uxpected error occured");
        }
        setLoading(false);
      });
  }, [slug]);
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="font-bold">
                EUR {office.price.toLocaleString("EUR")}
              </p>
            </div>
            <div className="flex items-center justify-between">
              <p className="font-semibold">Unique Code</p>
              <p className="font-bold text-[#FF2D2D]">-EUR {uniqueCode}</p>
            </div>
            <div className="flex items-center justify-between">
              <p className="font-semibold">Grand Total</p>
              <p className="font-bold text-[22px] leading-[33px] text-[#0D903A]">
                EUR{" "}
                {totalAmountWithUniqueCode.toLocaleString("EUR", {
